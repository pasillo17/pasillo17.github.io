...
const Footer: React.FC = () => {
  return (
    <footer id="contact" className="py-24 bg-slate-950 border-t border-white/5 relative">
      <div className="max-w-7xl mx-auto px-6 text-center">
        ...
        >
            <h2 className="text-5xl md:text-6xl font-display font-bold text-white mb-8 tracking-tighter">
                ¿ESTÁS LISTO PARA HACER <span className="text-brand-blue italic pr-2 text-glow drop-shadow-[0_0_25px_rgba(0,123,255,0.8)]">HISTORIA?</span>
            </h2>
            <p className="text-slate-400 mb-12 max-w-xl mx-auto">
                Vení a Pasillo17 y dale a tu música el sonido que se merece. Sesiones abiertas de Lunes a Sábados.
            </p>
        ...
        <div className="grid md:grid-cols-3 gap-12 text-left pt-16 border-t border-white/10">
          <div>
            ...
            <p className="text-slate-500 text-sm">
                Tu estudio de grabación en el corazón de la ciudad. Equipamiento profesional y ambiente de primer nivel.
            </p>
          </div>
          
          <div>
            <h5 className="text-white font-bold mb-6 uppercase text-sm tracking-widest">Navegación</h5>
            <ul className="text-slate-500 text-sm space-y-3">
              <li><a href="#" className="hover:text-brand-blue transition-colors">Inicio</a></li>
              <li><a href="#about" className="hover:text-brand-blue transition-colors">Sobre el estudio</a></li>
              <li><a href="#portfolio" className="hover:text-brand-blue transition-colors">Portafolio</a></li>
              <li><a href="#pricing" className="hover:text-brand-blue transition-colors">Servicios</a></li>
            </ul>
          </div>
          
          <div>
            <h5 className="text-white font-bold mb-6 uppercase text-sm tracking-widest">Seguinos</h5>
            <div className="flex gap-4">
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="w-10 h-10 rounded-full glass-panel flex items-center justify-center hover:bg-gradient-to-tr hover:from-orange-500 hover:via-pink-500 hover:to-purple-600 hover:text-white text-slate-400 transition-all duration-300"
              >
                <Instagram size={18} />
              </a>
