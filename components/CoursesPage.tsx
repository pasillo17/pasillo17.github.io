...
const CoursesPage: React.FC = () => {
  return (
    <div className="min-h-screen bg-[#030509] text-white font-sans selection:bg-brand-blue/30 pb-20">
      {/* Background Effects */}
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-[10%] right-[10%] w-[500px] h-[500px] bg-blue-600/10 blur-[150px] rounded-full mix-blend-screen"></div>
        <div className="absolute bottom-[10%] left-[10%] w-[500px] h-[500px] bg-brand-blue/10 blur-[150px] rounded-full mix-blend-screen"></div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          >
            Lleva tu carrera al siguiente nivel con conocimientos prácticos y
            directos al grano. Sin relleno, solo lo que necesitas saber para
          ...
          {COURSES.map((course, index) => (
            ...
            >
              ...
              <div className="p-6 md:p-8 flex-1 flex flex-col justify-between">
                ...
                <button
                  disabled
                  className="w-full py-3 bg-white/5 text-slate-400 rounded-lg font-bold text-sm tracking-widest cursor-not-allowed flex items-center justify-center gap-2 border border-white/5"
                >
                  PRÓXIMAMENTE...
                </button>
              </div>
