...
const FAQEquipment: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-gradient-to-b from-brand-dark via-slate-900 to-slate-950 overflow-hidden relative">
      <div className="max-w-7xl mx-auto px-6">
        
        {/* FAQ Section */}
        <div className="mb-20 border-b border-white/10 pb-12">
          <h2 className="text-3xl font-display font-bold text-white mb-8 uppercase">PREGUNTAS FRECUENTES</h2>
        ...
        <div className="grid md:grid-cols-2 gap-16 items-center">
          <div className="order-2 md:order-1">
            <h2 className="text-4xl font-display font-bold text-white mb-8 uppercase">EL ESTUDIO</h2>
            <div className="space-y-8">
              {EQUIPMENT.map((item, i) => {
                ...
                return (
                  ...
                  >
                    <div className="p-3 glass-panel rounded-lg text-brand-blue group-hover:bg-brand-blue group-hover:text-white transition-colors duration-300">
                        <Icon size={24} />
                    </div>
                    <div>
                      <h4 className="text-lg font-bold text-white mb-1 group-hover:text-brand-blue transition-colors">{item.title}</h4>
