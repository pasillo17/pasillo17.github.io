...
import { Play, Pause, SkipBack, SkipForward, ArrowLeft, Clock, Volume2, Heart, Share2, MoreHorizontal } from 'lucide-react';
...
const PlaylistPage: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-[#020617] text-white font-sans selection:bg-brand-blue selection:text-white pb-32">
      ...
      <div className="fixed inset-0 pointer-events-none z-0 overflow-hidden">
        <div className="absolute top-[-10%] left-[-10%] w-[60vw] h-[60vw] bg-blue-900/20 blur-[150px] rounded-full mix-blend-screen animate-pulse-slow"></div>
        <div className="absolute bottom-[-10%] right-[-10%] w-[60vw] h-[60vw] bg-indigo-900/20 blur-[150px] rounded-full mix-blend-screen animate-pulse-slow" style={{ animationDelay: '2s' }}></div>
        <div className="absolute top-[20%] left-[30%] w-[40vw] h-[40vw] bg-brand-blue/10 blur-[120px] rounded-full mix-blend-screen"></div>
      </div>
      ...
      <div className="sticky top-0 z-40 bg-[#020617]/80 backdrop-blur-lg border-b border-white/5 px-6 py-4 flex items-center justify-between">
         <Link to="/" className="inline-flex items-center gap-2 text-slate-400 hover:text-white transition-colors group">
          ...
          <div className="text-sm font-bold tracking-widest text-slate-500">PASILLO 17 STUDIO</div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-8 md:py-12 relative z-10">
        ...
        <div className="md:hidden flex flex-col items-center text-center mb-12">
            ...
            >
                <img src={currentTrack.image} alt="Cover" className="w-full h-full object-cover" />
            </motion.div>
            
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                <h5 className="text-xs font-bold text-brand-blue uppercase tracking-widest mb-2">Playlist Oficial</h5>
                <h1 className="text-4xl font-display font-bold mb-4 tracking-tight">BY PASILLO17</h1>
                ...
                <div className="flex items-center justify-center gap-4">
                    ...
                    <button className="p-3 rounded-full border border-white/10 hover:bg-white/10 transition-colors">
                        <Heart size={20} className={isLiked ? "fill-brand-blue text-brand-blue" : "text-white"} onClick={() => setIsLiked(!isLiked)} />
                    </button>
                </div>
            </motion.div>
        </div>
        ...
        <div className="hidden md:flex flex-row items-end gap-8 mb-16">
            ...
            <div className="flex-1">
                <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
                    <h5 className="text-xs font-bold text-brand-blue uppercase tracking-widest mb-2">Playlist Oficial</h5>
                    <h1 className="text-7xl font-display font-bold mb-4 tracking-tight">BY PASILLO17</h1>
                    <p className="text-slate-400 text-lg max-w-2xl mb-6">
                        Una selección curada de nuestras producciones más recientes. 
                        Grabación, mezcla y mastering con el sello de calidad de Pasillo 17.
                    </p>
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="hidden md:block w-8 text-center text-sm font-mono text-slate-500">
                                ...
                                <Play size={14} className={`hidden group-hover:block mx-auto ${isCurrent ? 'text-brand-blue' : 'text-white'}`} />
                            </div>
                            ...
                            <div className="flex items-center gap-3 md:gap-4">
                                <img src={track.image} alt={track.title} className="w-12 h-12 md:w-10 md:h-10 rounded md:rounded-sm shadow-sm object-cover" />
                                <div className="min-w-0">
                                    <h4 className={`font-bold text-sm md:text-base truncate ${isCurrent ? 'text-brand-blue' : 'text-white'}`}>{track.title}</h4>
      ...
      <div className="fixed bottom-0 left-0 right-0 bg-[#0a0a0a]/95 backdrop-blur-xl border-t border-white/10 px-4 md:px-6 py-3 md:py-4 z-50 pb-safe">
        <div className="max-w-7xl mx-auto flex items-center justify-between gap-4">
            ...
            <div className="flex items-center gap-3 md:gap-4 flex-1 md:w-1/3 min-w-0">
                <img src={currentTrack.image} alt={currentTrack.title} className="w-10 h-10 md:w-14 md:h-14 rounded md:rounded-lg shadow-lg object-cover" />
                <div className="min-w-0">
            ...
            <div className="flex md:hidden items-center gap-4">
                <button onClick={handlePlay.bind(null, currentTrack)} className="w-10 h-10 rounded-full bg-white text-black flex items-center justify-center shadow-lg active:scale-95 transition-transform">
            ...
            <div className="hidden md:flex flex-col items-center w-1/3">
                <div className="flex items-center gap-6 mb-2">
                    <button onClick={handlePrev} className="text-slate-400 hover:text-white transition-colors"><SkipBack size={20} /></button>
                    <button 
                        onClick={() => setIsPlaying(!isPlaying)}
                    ...
                    <button onClick={handleNext} className="text-slate-400 hover:text-white transition-colors"><SkipForward size={20} /></button>
                </div>
            ...
            <div className="flex items-center justify-end gap-4 w-1/3 hidden md:flex">
                ...
                <MoreHorizontal size={18} className="text-slate-400 hover:text-white cursor-pointer" />
            </div>
        </div>
